...
function About() {
  return (
    <div className="max-w-[1200px] mx-auto px-6 md:px-8 py-24 md:py-32">
      <p className="eyebrow text-[color:var(--gold)] mb-6">The House</p>
      <h1 className="font-serif italic text-5xl md:text-7xl leading-[1.05] max-w-3xl">Four generations. One thread.</h1>
